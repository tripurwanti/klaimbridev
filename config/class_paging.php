...
// Fungsi untuk menghitung total halaman
	...
	function navHalaman($halaman_aktif, $jmlhalaman){
		...
		if($halaman_aktif > 1){
			...
			$link_halaman .= " 	<a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=1 class='btn btn-info'><<</a> 
								<a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=$prev' class='btn btn-info'><</a>";
		} else { 
			$link_halaman .= " 	<a href='#' class='btn btn-info disabled'><<</a> 
		...
		for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
			if ($i < 1)
			continue;
			$angka .= " <a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=$i class='btn btn-info'>$i</a>";
		}
		$angka .= " <a href='#' class='btn btn-info disabled'>$halaman_aktif</a>";
		...
		$angka .= ($halaman_aktif+2<$jmlhalaman ? " ... <a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=$jmlhalaman class='btn btn-info'>$jmlhalaman</a>" : " ");
		...
		if($halaman_aktif < $jmlhalaman){
			...
			$link_halaman .= " 	<a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=$next class='btn btn-info'>></a> 
								<a href=http://10.10.1.247:81/klaimbni/media.php?module=$_GET[module]&q=$_GET[q]&halaman=$jmlhalaman class='btn btn-info'>>></a>";
		} else {
			$link_halaman .= " 	<a href='#' class='btn btn-info disabled'>></a> 
								<a href='#' class='btn btn-info disabled'>>></a>";
		}
