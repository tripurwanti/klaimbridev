            ...
            <div class="navbar-collapse">
                <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-files-o nav_icon"></i>Pengajuan Klaim<span
                        ...
                        <li>
                            <a href="#"><i class="fa fa-tasks nav_icon" style="color : white;"></i>Pelunasan Klaim<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <?php
                        ...
                        <?php
                                ...
                                ?>
                        <li>
                            <a href="#"><i class="fa fa-refresh nav_icon" style="color : white;"></i>Subrogasi<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <li>
                        ...
                        <?php
                                ...
                                ?>
                        <li>
                            <a href="#"><i class="fa fa-refresh nav_icon" style="color : white;"></i>Klaim Brisurf<span
                                    class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse">
                                <!-- <li>
                                    <a href="media.php?module=subroMonitoring"><i
                                ...
                                <li>
                                    <a href="media.php?module=claimListReportReconRC"><i
                                            class="fa fa-list nav_icon"></i>Report Recon Klaim</a>
                                </li>

                            </ul>
                        </li>
                        <li>
                            <a href="http://10.220.20.4/askred_bri" target="_blank"><i
                                    class="fa fa-home nav_icon"></i>Askred Program</a>
                        </li>
                        <?php
                                if ($_SESSION[username] == 'admin') {
                                ?>
